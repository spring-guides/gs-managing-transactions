...
You can use this https://start.spring.io/#!type=gradle-project&language=java&jvmVersion=17&groupId=com.example&artifactId=managing-transactions&packageName=com.example.managingtransactions&dependencies=data-jdbc,h2[pre-initialized project] and click Generate to download a ZIP file. This project is configured to fit the examples in this tutorial.
...
. Type "managing-transactions" in the "Artifact" form field.
...
books people into the system by name. The following listing shows how to do so:
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/managingtransactions/BookingService.kt[]
----
====
...
this application class. The following listing shows the application class:
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/managingtransactions/ManagingTransactionsApplication.kt[]
----
====
...
`h2` on the classpath and automatically creates a `DataSource` and a `JdbcTemplate` for you.
Because this infrastructure is now available and you have no dedicated configuration,
...
showcases various transactional use cases. The following listing shows the command line
runner:
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/managingtransactions/AppRunner.kt[]
----
====
