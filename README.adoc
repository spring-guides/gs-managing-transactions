...
There is also a http://docs.spring.io/spring-boot/docs/current/reference/htmlsingle/#boot-features-command-line-runner[`CommandLineRunner`] that injects the `BookingService` and showcases various transactional use cases.
