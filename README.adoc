...
You can use this https://start.spring.io/#!type=maven-project&groupId=com.example&artifactId=managing-transactions&name=managing-transactions&description=Demo%20project%20for%20Spring%20Boot&packageName=com.example.managingtransactions&dependencies=data-jdbc,h2[pre-initialized project] and click Generate to download a ZIP file. This project is configured to fit the examples in this tutorial.
